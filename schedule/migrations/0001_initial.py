# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-12-19 00:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(verbose_name='Hora do inicio')),
                ('end_time', models.TimeField(verbose_name='Hora do fim')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedule.Patient', verbose_name='Paciente')),
                ('procedure', models.ManyToManyField(to='schedule.Procedure', verbose_name='Procedimentos')),
            ],
            options={
